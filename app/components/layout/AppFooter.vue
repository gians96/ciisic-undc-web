        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <div class="flex items-center space-x-3">
            <div class="w-12 h-8 rounded flex items-center justify-center">
              <a href="https://facebook.com/fiundc" target="_blank"
                class="w-10 h-10 bg-[#0967FF] rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-200"
                aria-label="Discord">
                <Icon name="simple-icons:facebook" class="w-5 h-5 text-white" />
              </a>
            </div>
            <div class="w-12 h-8 rounded flex items-center justify-center">
              <a href="https://tiktok.com/@fiundc" target="_blank"
                class="w-10 h-10 bg-[#000] rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-200"
                aria-label="Twitter">
